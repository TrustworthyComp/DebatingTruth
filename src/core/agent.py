...
from ..utils.openai_client import OpenAIClient, MODEL_MAX_CONTEXT, DEFAULT_MAX_CONTEXT
...
class Agent:
    ...
    def ask(self, temperature: Optional[float] = None) -> Any:
        ...
        max_context = MODEL_MAX_CONTEXT.get(self.model_name, DEFAULT_MAX_CONTEXT)
